...
public class Constants {
    ...
    public static final String APP_ID = "Ay9KrTGqf8SotYFttNKLGaA81shRPdfVnFxosNVpmWMo";
    public static final String SDK_KEY = "FoUc7TmmehtXvwXikkfSPx3mT8xuMCdccj8McbRkBDr8";
